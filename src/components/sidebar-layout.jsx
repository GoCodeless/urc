...
export function SidebarLayout({ sidebar, footer, children }) {
  let [showSidebar, setShowSidebar] = useState(false)

  return (
    <div className="relative isolate flex min-h-svh w-full bg-white flex-col lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950">
      {/* Mobile Sidebar */}
          ...
          <SidebarHeader>
            <Dropdown>
              <DropdownButton as={SidebarItem}>
                <Avatar src="/teams/urc.png" square />
                <SidebarLabel>Crossett Inc</SidebarLabel>
              </DropdownButton>
            </Dropdown>
          </SidebarHeader>
          </div>
